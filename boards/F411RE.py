...
info = {
 ...
 'default_console' : "EV_SERIAL1", # USART2 by default, the Nucleo's USB is actually running on this too
 'default_console_tx' : "A11", # USART2_TX on PA2,
 'default_console_rx' : "A12", # USART2_RX on PA3
 'variables' :  7423, # (128-12)*1024/16-1
 'binary_name' : 'espruino_%v_f411re.bin',
 'build' : {
   'optimizeflags' : '-O3',
   'libraries' : [
     'NET',
