...
info = {
 ...
 'bootloader' : 1,
 'binary_name' : 'espruino_%v_beacon.hex',
 'build' : {
   'optimizeflags' : '-Os',
   'libraries' : [
     'BLUETOOTH',
   ...
   'makefile' : [
     ...
     'DEFINES+=-DBLUETOOTH_NAME_PREFIX=\'"BEACON"\'',
...
devices = {
  'LED1' : { 'pin' : 'D19' },
  'LED2' : { 'pin' : 'D17' }, # don't use LED2 in the bootloader since we may be using a bare module
  'BTN1' : { 'pin' : 'D11', 'pinstate' : 'IN_PULLDOWN' },
